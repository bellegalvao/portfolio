...
export function AboutContent() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-4 md:py-8">
      {/* Header + foto grande lateral */}
      <div className="flex flex-col md:flex-row items-start gap-10 md:gap-16 mb-12">
        ...
        {/* Foto grande — desktop lateral */}
        <div className="relative hidden md:block md:w-72 md:self-stretch shrink-0 rounded-2xl overflow-hidden">
          <Image
